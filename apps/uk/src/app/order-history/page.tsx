    ...
    <section className="Muuhu-section bg-[var(--cream)] py-16 md:py-24">
      <div className="Muuhu-wrap">
        <div className="mb-10 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <p className="Muuhu-eyebrow">Order history</p>
            <h1 className="Muuhu-heading mt-3">Your Muuhu orders.</h1>
        ...
        {orders.length ? (
          ...
          <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-10 text-center">
            ...
            <h2 className="Muuhu-display mt-5 text-3xl text-[var(--plum)]">
              No recorded orders yet.
            </h2>
            <p className="Muuhu-copy mx-auto mt-3 max-w-lg">
