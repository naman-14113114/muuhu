...
export function VideoReviews() {
  return (
    <section className="Muuhu-section bg-[#FEFAF2] pt-14 md:pt-24 pb-4 md:pb-6 overflow-hidden">
      <style>{`
      ...
      <div className="Muuhu-wrap">
        <SectionHeading
          ...
          title={
            <>
              Muuhu Mask <span className="Muuhu-italic text-[var(--gold)]">reviews</span> <span className="font-serif italic text-[var(--plum)]">&</span> real results
            </>
          }
        />
