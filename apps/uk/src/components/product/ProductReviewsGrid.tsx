  ...
  return (
    <div className="mt-6 space-y-2">
      <button
        ...
        type="button"
      >
        <span className="Muuhu-mono text-[var(--plum-soft)]">All reviews</span>
        <span className="Muuhu-mono text-[var(--plum-soft)]">
        ...
        return (
          ...
          >
            <span className="inline-flex items-center gap-1 text-[var(--gold)]">
              ...
              <span className="Muuhu-mono text-[var(--plum-soft)]">{rating} star</span>
            </span>
            ...
            <span className="Muuhu-mono text-right text-[var(--plum-soft)]">
    ...
    >
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-nowrap items-center gap-1.5 sm:gap-3">
          <span className="Muuhu-display text-sm sm:text-xl text-[var(--plum)]">Filters</span>
          <div className="relative">
            <button
              aria-controls="Muuhu-review-stars-menu"
            ...
            {openMenu === "stars" ? (
              <div className={menuClass} id="Muuhu-review-stars-menu" role="menu">
        ...
        <div className="relative flex flex-wrap items-center gap-3 lg:justify-end">
          <span className="Muuhu-display text-xl text-[var(--plum)]">Sort by</span>
          <button
            aria-controls="Muuhu-review-sort-menu"
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between sm:gap-2">
        ...
        <span className="Muuhu-mono whitespace-nowrap text-[0.55rem] sm:text-[0.65rem] text-[var(--plum-soft)]">
          {review.displayDate || review.date}
        </span>
      </div>

      {review.title ? (
        <h3 className="Muuhu-display mt-2 sm:mt-4 text-[0.85rem] sm:text-xl leading-snug text-[var(--plum)]">
          {review.title}
        </h3>
      ) : null}
      ...
      <div className="mt-3 sm:mt-6 flex items-center justify-between gap-1 sm:gap-2 border-t border-[rgba(58,31,61,.12)] pt-3 sm:pt-4">
        <span className="Muuhu-display min-w-0 text-[0.7rem] sm:text-sm text-[var(--plum)] whitespace-nowrap overflow-hidden text-ellipsis">
    ...
    >
      ...
      >
        ...
        <div className="w-full overflow-y-auto px-6 pb-7 pt-20 sm:px-8 lg:w-[min(34vw,28rem)] lg:flex-none lg:px-9">
          <p className="Muuhu-mono text-[var(--gold)]">Verified customer review</p>
          ...
          {review.title ? (
            <h3 className="Muuhu-display mt-6 text-3xl leading-tight text-[var(--plum)]">
              {review.title}
            </h3>
          ) : null}
          ...
          <div className="mt-8 flex items-center gap-2 border-t border-[rgba(58,31,61,.12)] pt-5 text-[var(--plum)]">
            ...
            <span className="Muuhu-display text-lg">{review.customerName}</span>
          </div>
        </div>
      </div>
    </div>,
      ...
      >
        ...
        {isPublished ? (
          <div className="grid min-h-[24rem] place-items-center text-center">
            <div>
              <p className="Muuhu-mono text-[var(--gold)]">Review published</p>
              <h3 className="Muuhu-display mt-4 text-4xl text-[var(--plum)]">
                Thank you for sharing your glow.
              </h3>
              <p className="mx-auto mt-4 max-w-xl text-base leading-7 text-[var(--muted)]">
                Your review is live in the Muuhu archive now.
              </p>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="max-w-2xl">
              <p className="Muuhu-mono text-[var(--gold)]">Customer review</p>
              <h3 className="Muuhu-display mt-3 text-4xl leading-tight text-[var(--plum)]">
            ...
            <div>
              <label className="Muuhu-mono mb-3 block text-[var(--plum-soft)]">
                Your rating
              </label>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <label className="block">
                <span className="Muuhu-mono mb-2 flex justify-between text-[var(--plum-soft)]">
                  Title of review
            ...
            <label className="block">
              <span className="Muuhu-mono mb-2 block text-[var(--plum-soft)]">
                Your email
              </span>
              <input
                className="w-full rounded-[14px] border border-[rgba(58,31,61,.16)] bg-[rgba(255,252,245,.78)] px-4 py-3 text-[var(--plum)] outline-none transition focus:border-[var(--gold)]"
  ...
  return (
    <div>
      <div className="mb-12 grid gap-8 lg:grid-cols-[1fr_0.82fr] lg:items-end">
          ...
          <SectionHeading
            ...
            title={
              productHandle === "buudy-red-torch" ? (
                ...
                <>
                  Muuhu Mask <em className="Muuhu-italic">customer reviews</em>.
                </>
              )
            }
            copy={
        ...
        <div className="rounded-[22px] border border-[rgba(58,31,61,.14)] bg-[rgba(255,252,245,.72)] p-6 shadow-[0_20px_52px_-42px_rgba(58,31,61,.55)]">
          <div className="flex flex-wrap items-end justify-between gap-5">
            <div>
              <p className="Muuhu-mono text-[var(--gold)]">Average rating</p>
              <p className="Muuhu-display mt-2 text-6xl leading-none text-[var(--plum)]">
                {currentAverageRating.toFixed(1)}
              </p>
            </div>
            <div className="text-right">
              <p className="Muuhu-mono text-[var(--plum-soft)]">Verified archive</p>
      ...
      {reviews.length ? (
        ...
        >
          <p className="Muuhu-display text-2xl text-[var(--plum)]">
      ...
      <div className="mt-10 flex flex-col items-center gap-4 text-center">
        <p className="Muuhu-mono text-[var(--plum-soft)]">
