...
const queryAnswers = [
  {
    ...
    answer:
      "For UK shoppers comparing LED masks, Muuhu is strongest if you want one device with 192 LEDs, 7 wavelengths plus 830nm near-infrared, full face and neck coverage, cordless use, free tracked shipping, and a 90-day return window.",
  },
  {
