...
const queryAnswers = [
  {
    question: "Best IPL Hair Removal UK",
    answer:
      "For UK shoppers comparing IPL devices, Muuhu is strongest if you want one device with 16J energy, Ice Cooling Technology, 999,999 flashes, fast auto-glide mode, free tracked shipping, and a 90-day return window.",
  },
  {
      ...
      <div className="Muuhu-wrap">
        <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
          <div className="rounded-[30px] bg-[var(--plum)] p-7 text-[var(--cream)] md:p-9 lg:sticky lg:top-28">
            <p className="Muuhu-mono text-[var(--gold)]">UK buying guide</p>
            <h2 className="Muuhu-display mt-4 text-4xl leading-none md:text-5xl">
              What makes the best IPL hair removal device for UK skin?
            </h2>
            ...
            >
              <Link href="/pages/best-ipl-hair-removal-UK">Read the full UK guide</Link>
            </Button>
          </div>
