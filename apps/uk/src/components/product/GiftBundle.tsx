...
export function GiftBundle({ product }: { product: Product }) {
  ...
  return (
    <div>
      ...
      <h1 className="font-serif mt-3 whitespace-nowrap text-[2rem] leading-[1.02] text-[var(--plum)] sm:text-[2.55rem] md:text-[3.25rem] xl:text-[4rem] 2xl:text-[4.45rem]">
        {product.heroTitle}{" "}
      ...
      <div className="mt-3 flex flex-nowrap items-center gap-0.5 sm:gap-1.5 w-full">
        <span className="inline-flex items-center gap-1 sm:gap-1 rounded-full border border-[rgba(58,31,61,.15)] bg-[var(--card)] px-1.5 sm:px-2 py-1 sm:py-1">
          ...
          />
          <span className="whitespace-nowrap Muuhu-display text-[8px] sm:text-[9.5px] font-bold uppercase tracking-[0.02em] sm:tracking-[0.02em] text-[var(--plum)]">
            Clinically Proven
          </span>
        </span>
        <span className="inline-flex items-center gap-1 sm:gap-1 rounded-full border border-[rgba(58,31,61,.15)] bg-[var(--card)] px-1.5 sm:px-2 py-1 sm:py-1">
      ...
      <div className="mt-4 flex flex-col gap-2.5">
        ...
        <div className="flex flex-nowrap items-center gap-x-1 sm:gap-x-1.5 text-[9.5px] sm:text-[13px] text-[var(--muted)]">
          <span className="whitespace-nowrap tracking-tight sm:tracking-normal">
            or{" "}
            <strong className="Muuhu-display text-[10px] sm:text-[14px] font-medium text-[var(--plum)]">
              4
            </strong>{" "}
            interest-free payments of{" "}
            <strong className="Muuhu-display text-[10px] sm:text-[14px] font-semibold text-[var(--plum)]">
