...
function ContactHero() {
  return (
    <section className="Muuhu-section bg-[var(--cream)] py-16 md:py-24">
      <div className="Muuhu-glow -left-24 top-8 h-[440px] w-[440px] bg-[#ED6A3A]" />
      <div className="Muuhu-glow -right-24 bottom-0 h-[480px] w-[480px] bg-[#a05080]" />

      <div className="Muuhu-wrap relative z-10 grid gap-12 lg:grid-cols-[1.02fr_.98fr] lg:items-center">
        <div>
          <p className="Muuhu-eyebrow">{contactPage.eyebrow}</p>
          <h1 className="Muuhu-display mt-5 text-[3.2rem] leading-[1.02] text-[var(--plum)] sm:text-[4.5rem] md:text-[5.8rem]">
            {contactPage.title.split(" ").slice(0, -1).join(" ")}{" "}
            <em className="Muuhu-italic">
              {contactPage.title.split(" ").slice(-1).join(" ")}
            </em>
          </h1>
          <p className="Muuhu-copy mt-6 max-w-2xl text-lg">{contactPage.copy}</p>

          <div className="mt-8 flex flex-wrap gap-3">
            <a
              className="Muuhu-mono rounded-full bg-[var(--plum)] px-4 py-3 text-[var(--cream)] transition hover:bg-[var(--cream)] hover:text-[var(--ink)]"
              href="mailto:support@Muuhu.com"
            >
              {contactPage.supportLabel}
            </a>
            <span className="Muuhu-mono rounded-full border border-[var(--border)] bg-[rgba(247,241,232,.72)] px-4 py-3 text-[var(--plum)]">
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-5 left-5 right-5 rounded-2xl bg-[rgba(58,31,61,.9)] p-5 text-[var(--cream)] shadow-[0_20px_55px_-30px_rgba(0,0,0,.6)]">
            <div className="flex items-center gap-3">
              ...
              <p className="Muuhu-mono text-[var(--gold)]">Support desk</p>
            </div>
...
function HelpAndSocial() {
  return (
    <section className="Muuhu-section bg-[var(--plum)] py-24 text-[var(--cream)]">
      <div className="Muuhu-wrap grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
        <SectionHeading
          eyebrow="Help center"
          title={
            <>
              FAQ, help, and <em className="Muuhu-italic">social updates</em>.
            </>
          }
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {contactHelpLinks.map((link) => (
            ...
            >
              ...
              <h2 className="Muuhu-display mt-4 text-2xl">{link.label}</h2>
        ...
        <div className="lg:col-start-2">
          <p className="Muuhu-mono text-[var(--gold)]">Connect with us</p>
...
function FormSection() {
  return (
    <section className="Muuhu-section bg-[var(--cream)] py-24" id="contact-form">
      <div className="Muuhu-glow -left-32 top-10 h-[400px] w-[400px] bg-[#ED6A3A]" />
      <div className="Muuhu-wrap relative z-10 grid gap-12 lg:grid-cols-[.82fr_1.18fr] lg:items-start">
        <div>
          <SectionHeading
            eyebrow="Contact form"
            title={
              <>
                Send us a <em className="Muuhu-italic">message</em>.
              </>
            }
