...
const STORAGE_KEY = "Muuhu:skincare-quiz:v1";
...
function QuizIntro({
  ...
  return (
    <div className="flex min-h-[540px] flex-col justify-center">
      <p className="Muuhu-eyebrow">60-second assessment</p>
      <h2 className="Muuhu-display mt-4 text-[2.8rem] leading-[1.02] text-[var(--plum)] md:text-[4rem]">
        Build your custom <em className="Muuhu-italic">routine</em>.
      </h2>
      ...
      {savedQuiz ? (
        <div className="mt-8 rounded-[14px] border border-[rgba(180,145,76,.38)] bg-[rgba(180,145,76,.09)] p-5">
          <p className="Muuhu-mono text-[var(--gold)]">Routine in progress</p>
  ...
  return (
    <div>
      <div className="flex items-center justify-between gap-4">
        <p className="Muuhu-mono text-[var(--gold)]">
      ...
      <h2 className="Muuhu-display mt-9 text-[2.25rem] leading-[1.06] text-[var(--plum)] md:text-[3.2rem]">
...
function QuizAnalyzing() {
  return (
    ...
    >
      ...
      <p className="Muuhu-eyebrow mt-8">Analyzing data</p>
      <h2 className="Muuhu-display mt-3 text-4xl text-[var(--plum)]">
        Formulating your routine.
      </h2>
      <p className="Muuhu-copy mt-3 max-w-md text-sm">
  ...
  return (
    <div>
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="Muuhu-eyebrow">Your skin dossier</p>
          <h2 className="Muuhu-display mt-3 text-[2.8rem] leading-none text-[var(--plum)] md:text-[4rem]">
            Your routine, <em className="Muuhu-italic">revealed</em>.
          </h2>
        </div>
        <button
          className="inline-flex items-center gap-2 text-xs font-semibold text-[var(--muted)] transition hover:text-[var(--plum)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[var(--gold)]"
      ...
      <div className="mt-6 rounded-[14px] border border-[rgba(180,145,76,.34)] bg-[rgba(180,145,76,.08)] p-4">
        <p className="Muuhu-mono text-[var(--gold)]">Profile</p>
        ...
        {result.routine.map((step) => (
          ...
          >
            ...
            <div>
              ...
              {step.highlighted ? (
                <p className="Muuhu-mono mt-2 text-[var(--gold)]">
      ...
      <div className="mt-6 rounded-[14px] bg-[var(--blush)] p-5 text-center sm:p-7">
        ...
        <h3 className="Muuhu-display mt-3 text-3xl text-[var(--plum)]">
