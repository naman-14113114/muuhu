...
export function CartPageContent({
  ...
  return (
    <section className="Muuhu-section bg-[var(--cream)] pt-2 pb-8 md:pt-4 md:pb-12">
            ...
            <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
              ...
              >
                <span className="flex items-center gap-3">
                  ...
                  <span>
                    <span className="Muuhu-mono block text-[var(--plum)]">
                      Add Gift Message
                    </span>
                ...
                <span className="flex items-center gap-3">
                  <span className="Muuhu-mono hidden text-[var(--gold)] sm:inline">
              ...
              >
                <div className="overflow-hidden">
                  <div className="mt-4 flex justify-end sm:hidden">
                    <span className="Muuhu-mono text-[var(--gold)]">
                      {giftMessage.length}/300
                    </span>
                  </div>
                  <textarea
...
function CartRestoringState() {
  return (
    <section
      aria-live="polite"
      aria-busy="true"
      className="Muuhu-section bg-[var(--cream)] py-28"
    >
      <div className="Muuhu-wrap max-w-2xl text-center">
        <ShoppingBag
          ...
          size={42}
        />
        <h1 className="Muuhu-heading mt-5">Restoring your bag...</h1>
        <p className="Muuhu-copy mx-auto mt-5 max-w-lg">
