...
export function Header() {
  ...
  return (
    <header
      className="relative z-40 border-b border-[rgba(58,31,61,.14)] bg-white backdrop-blur-xl"
    >
      <div className="Muuhu-wrap relative flex min-h-[64px] items-center justify-between gap-4 lg:min-h-[72px] lg:gap-6">
        <button
        ...
        <nav className="hidden gap-7 lg:flex" aria-label="Primary">
          {primaryNavigation.map((item) => (
            <Link
              className="Muuhu-mono text-[var(--plum)] opacity-80 transition hover:opacity-100"
              href={item.href}
              key={item.label}
            >
              {item.label}
        ...
        <div className="flex items-center gap-3 lg:gap-6">
          ...
          >
            ...
            {totals.itemCount > 0 ? (
              <span className="Muuhu-mono absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full bg-[var(--plum)] px-1 text-[0.58rem] leading-none text-[var(--cream)]">
                {totals.itemCount}
              </span>
            ) : null}
          </button>
              ...
              >
                <div className="border-b border-[var(--border)] p-4">
                  <p className="Muuhu-mono text-[var(--gold)]">
                    {signedIn ? "Signed in" : "Muuhu account"}
                  </p>
            ...
            >
              ...
              >
                ...
                <div className="flex-1 px-4 py-5">
                  <p className="Muuhu-eyebrow px-2">Shop</p>
                  ...
                  <p className="Muuhu-eyebrow mt-7 px-2">Help</p>
                  ...
                  <p className="Muuhu-eyebrow mt-7 px-2">Account</p>
                  <div className="mt-2">
                    {signedIn ? (
                      <>
                        <MobileMenuLink
