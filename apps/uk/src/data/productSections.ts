...
export const massagerFeatures: Feature[] = [
  {
    ...
    body: "Designed to glide smoothly over your skin to promote lymphatic drainage and visibly reduce facial puffiness.",
  },
  {
    title: "Massage Comb",
    kicker: "Relieve Tension",
    body: "The wide-toothed resin comb is perfect for massaging the scalp and neck, releasing deep tension without tangling hair.",
  },
  {
    title: "Acupuncture Beauty Pen",
    kicker: "Targeted Relief",
    body: "Use the beauty pen for precise pressure points on the face or body to relieve localized stiffness and tension.",
  },
];
...
export const massagerHowToUse = [
  "Start with a clean face and apply your favorite facial oil or serum to provide slip.",
  ...
  "Use the massage comb on your scalp in slow, sweeping motions to release tension.",
  "Use the acupuncture beauty pen to apply gentle pressure to specific tension points as needed.",
];
