...
export const faqsData: FaqItem[] = [
  ...
  },
  {
    ...
    answerHtml: `
      <p class="text-sm leading-6">You can reach our customer service through our <a href="/pages/contact-us#contact-form" class="underline text-[var(--plum)] font-semibold">Contact Us</a> page or by emailing <a href="mailto:support@muuhu.com" class="underline text-[var(--plum)] font-semibold">support@muuhu.com</a>.</p>
    `
  },
  {
    question: "My tracking number isn't working",
    answerHtml: `
      <p class="text-sm leading-6">Tracking numbers can take 1 to 2 business days to appear in the shipping carrier's system. If your tracking number is still not working after that window, please email <a href="mailto:support@muuhu.com" class="underline text-[var(--plum)] font-semibold">support@muuhu.com</a> or use our <a href="/pages/contact-us#contact-form" class="underline text-[var(--plum)] font-semibold">Contact Form</a>.</p>
    `
  },
  {
