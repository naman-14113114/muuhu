...
export const freeGiftDetails: FreeGiftDetail[] = [
  ...
  },
  {
    ...
    seoDescription:
      "Explore the targeted Muuhu Red Light Torch included as a free companion gift with the Muuhu Ultra Pro offer.",
    intro:
    ...
    note:
      "The current Muuhu Ultra Pro offer includes the Red Light Torch as a free bonus gift.",
