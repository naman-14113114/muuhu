...
export const freeGiftDetails: FreeGiftDetail[] = [
  ...
  },
  {
    ...
    eyebrow: "Free Bonus Gift",
    title: "Muuhu Massage Kit",
    seoTitle: "Muuhu Massage Kit Bonus Gift",
    seoDescription:
      "Explore the targeted Muuhu Massage Kit included as a free companion gift with the Muuhu Ultra Pro offer.",
    intro:
      "The Muuhu Massage Kit adds precision to the main device offer. While the IPL device gives you broad face-and-neck coverage, the massage kit gives you traditional tools you can use for targeted touch-up areas and travel-friendly sessions.",
    note:
      "The current Muuhu Ultra Pro offer includes the Massage Kit as a free bonus gift.",
    image: productMediaAsset("massage_kit_spotlight.png"),
    imageAlt: "Muuhu Massage Kit bonus gift",
