    ...
    <section className="Muuhu-section bg-[var(--cream)] py-16 md:py-24">
      <div className="Muuhu-wrap">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
          <div>
            <p className="Muuhu-eyebrow">Customer</p>
            <h1 className="Muuhu-heading mt-3">
            ...
            <section className="mt-8 rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Order history</p>
          ...
          <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Profile id</p>
            ...
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Shipping</p>
            ...
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Account signals</p>
  ...
  return (
    <section className="Muuhu-section bg-[var(--cream)] py-20 md:py-28">
      <div className="Muuhu-wrap max-w-2xl text-center">
        ...
        <h1 className="Muuhu-heading mt-4">Customer unavailable.</h1>
