    ...
    <section className="Muuhu-section bg-[var(--cream)] py-16 md:py-24">
      <div className="Muuhu-wrap">
        <div className="mb-10 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <p className="Muuhu-eyebrow">Admin</p>
            <h1 className="Muuhu-heading mt-3">Muuhu dashboard.</h1>
        ...
        <div className="mt-8 grid gap-8 xl:grid-cols-[1.2fr_0.8fr]">
          <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
            <div className="mb-5 flex items-center justify-between gap-4">
              <div>
                <p className="Muuhu-mono text-[var(--gold)]">Orders</p>
                <h2 className="Muuhu-display mt-1 text-3xl text-[var(--plum)]">
                  Recent sales
                </h2>
              </div>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full min-w-[760px] text-left text-sm">
                <thead className="Muuhu-mono border-b border-[var(--border)] text-[var(--muted)]">
                  <tr>
          ...
          <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
            <div className="mb-5">
              <p className="Muuhu-mono text-[var(--gold)]">Customers</p>
              <h2 className="Muuhu-display mt-1 text-3xl text-[var(--plum)]">
                Known profiles
              </h2>
            </div>
...
function MetricCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-5">
      ...
      <p className="Muuhu-display mt-3 text-4xl text-[var(--plum)]">{value}</p>
    </div>
  );
}
  ...
  return (
    <section className="Muuhu-section bg-[var(--cream)] py-20 md:py-28">
      <div className="Muuhu-wrap max-w-2xl text-center">
        <p className="Muuhu-eyebrow">Admin setup</p>
        <h1 className="Muuhu-heading mt-4">Supabase admin env missing.</h1>
