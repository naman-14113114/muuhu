    ...
    <section className="Muuhu-section bg-[var(--cream)] py-16 md:py-24">
      <div className="Muuhu-wrap">
        ...
        <div className="mt-8 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <p className="Muuhu-eyebrow">Order detail</p>
            <h1 className="Muuhu-heading mt-3">{order.order_number}</h1>
            <p className="Muuhu-copy mt-4 max-w-2xl">
              Sale status, customer snapshot, items, gifts, promos, and totals
              captured at checkout.
            </p>
          </div>
          <p className="Muuhu-display text-5xl text-[var(--plum)]">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_380px]">
          <div className="space-y-8">
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Items</p>
            ...
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Gift bundle</p>
          ...
          <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start">
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Customer snapshot</p>
            ...
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Order signals</p>
            ...
            <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Totals</p>
              <div className="mt-4 space-y-3 text-sm">
  ...
  return (
    <section className="Muuhu-section bg-[var(--cream)] py-20 md:py-28">
      <div className="Muuhu-wrap max-w-2xl text-center">
        ...
        <h1 className="Muuhu-heading mt-5">Order unavailable.</h1>
        <p className="Muuhu-copy mx-auto mt-5 max-w-lg">{message}</p>
