...
export const muuhuIpl: Product = {
  ...
  description:
    "At-home IPL hair removal reimagined for Canadian homes. The Muuhu IPL combines 999,999 flashes, built-in ice cooling at 8°C, 9 adjustable energy levels up to 16J, Auto and Manual modes, and an LCD touch display for painless, long-lasting hair reduction across your entire body.",
  seoTitle: "Best IPL Hair Removal Canada | Muuhu Ice Cooling Device",
  seoDescription:
    "Shop the Muuhu IPL Hair Removal in Canada: 999,999 flashes, ice cooling, 9 energy levels, 16J max output, Auto and Manual modes, LCD touch display, 90-day returns, and free shipping.",
  ...
  included: [
    ...
    { quantity: "1×", label: "Muuhu IPL Device" },
