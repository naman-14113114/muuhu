...
export const muuhuIpl: Product = {
  ...
  description:
    "At-home IPL hair removal reimagined for Canadian homes. The Muuhu IPL combines 999,999 flashes, built-in ice cooling at 8Ã‚Â°C, 9 adjustable energy levels up to 16J, Auto and Manual modes, and an LCD touch display for painless, long-lasting hair reduction across your entire body.",
