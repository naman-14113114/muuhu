...
export const aboutSections = [
  {
    ...
    eyebrow: "Who we are",
    title: "Our Team",
    copy: "Behind Muuhu is a close-knit team of skincare enthusiasts, tech innovators, and customer advocates. We aren't just selling a product; we use the Muuhu Ultra Pro ourselves. From our product design team ensuring the optimal output of every IPL flash, to our dedicated customer support squad who are always ready to guide you on your hair removal journey, everyone at Muuhu is united by one common goal: delivering an exceptional experience and real, visible results to you.",
    image: {
