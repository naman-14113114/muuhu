...
export const freeGiftDetails: FreeGiftDetail[] = [
  ...
  },
  {
    ...
    intro:
      "The Muuhu Massage Kit adds precision to the main device offer. While the IPL device gives you broad face-and-neck coverage, the torch gives you a smaller tool you can use for targeted touch-up areas and travel-friendly sessions.",
    note:
