...
export function WavelengthSelector() {
  ...
  return (
    <section className="Muuhu-section overflow-hidden bg-[var(--ink)] py-14 text-[var(--cream)] md:py-24">
      <div
        className="Muuhu-glow -left-40 top-1/2 h-[500px] w-[500px] -translate-y-1/2 transition-colors duration-700"
        style={{ background: `${active.color}15` }}
      />
      <div className="Muuhu-wrap relative z-10">
        <div className="max-w-full lg:max-w-5xl">
          <p className="Muuhu-mono text-[var(--gold)]">Spectrum</p>
          <h2 className="Muuhu-display mt-3 text-[2.5rem] leading-[1.06] text-[var(--cream)] md:text-6xl">
            Change <em className="Muuhu-italic">7 light modes</em> with a tap.
          </h2>
        </div>
              ...
              return (
                <li key={wavelength.name}>
                  ...
                  >
                    ...
                    />
                    <span className="Muuhu-display w-20 uppercase text-[rgba(247,241,232,.6)]">
                      {wavelength.nm}
                    </span>
                    <span className={`Muuhu-display text-xl transition-colors duration-300 ${
                      isActive ? "text-[var(--gold)]" : "text-[var(--cream)] group-hover:text-[var(--gold)]"
                    }`}>
                      {wavelength.name}
                    </span>
                    <span className="Muuhu-display ml-auto hidden text-sm text-[rgba(247,241,232,.6)] sm:block">
