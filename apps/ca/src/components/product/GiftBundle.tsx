        ...
        <div className="flex items-center justify-between gap-2 sm:gap-5">
          <div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <p className="Muuhu-eyebrow text-[var(--gold)] m-0 leading-none flex items-center h-5 sm:h-7 font-bold text-[10px] sm:text-xs">
                FREE DELIVERY
              </p>
            </div>
            <p className="Muuhu-display mt-1.5 text-base sm:text-2xl text-[var(--plum)] font-normal leading-none whitespace-nowrap">
              {deliveryDate || "soon"}
            </p>
          </div>
          <div className="text-right">
            <p className="Muuhu-eyebrow text-[var(--gold)] whitespace-nowrap text-[9px] sm:text-[11px] tracking-tight sm:tracking-normal">
              {hasGifts ? "ORDER WITHIN" : "ORDER TODAY"}
            </p>
            <p className="Muuhu-display mt-1.5 text-xl sm:text-[2.2rem] font-normal text-[var(--plum)] leading-none">
              {timer}
            </p>
          </div>
        </div>
