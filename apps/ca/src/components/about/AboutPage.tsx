    ...
    <div className="bg-[var(--cream)] min-h-screen">
      ...
      <section className="relative overflow-hidden py-14 md:py-24 text-center bg-black">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 sm:px-6">
          <p className="Muuhu-mono text-[var(--gold)] tracking-[0.2em] uppercase text-xs sm:text-sm font-semibold">
            {aboutHero.eyebrow}
          </p>
          <h1 className="Muuhu-display mt-4 text-[2.8rem] leading-[1.05] text-[var(--cream)] sm:text-[3.5rem] md:text-7xl font-light">
            Welcome to <em className="Muuhu-italic">Muuhu.com</em>
          </h1>
      ...
      <div className="relative z-10">
        {aboutSections.filter(s => s.id !== "customer-support").map((section) => {
          ...
          return (
            <section
              key={section.id}
              className="Muuhu-section py-6 md:py-10 transition-all duration-300"
            >
      ...
      <div className="relative z-10">
        {aboutSections.filter(s => s.id === "customer-support").map((section) => (
          <section
            key={section.id}
            className="Muuhu-section py-14 md:py-24 transition-all duration-300"
          >
            <div className="Muuhu-wrap max-w-3xl mx-auto text-center">
              <SectionHeading
                eyebrow={section.eyebrow}
                title={
                  <>
