...
function TrackingFaqItem({
  ...
  return (
    ...
    >
      ...
      >
        <span className="Muuhu-display text-base font-normal text-[var(--plum)] sm:text-lg">{question}</span>
        <span
...
export function OrderTrackingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[var(--cream)] py-16 md:py-24">
      <div className="Muuhu-glow -left-20 top-12 h-[340px] w-[340px] bg-[#ED6A3A] opacity-10" />
      <div className="Muuhu-glow -right-20 bottom-12 h-[380px] w-[380px] bg-[#a05080] opacity-10" />
      ...
      <div className="Muuhu-wrap relative z-10 max-w-4xl px-4 sm:px-6">
        <div className="mb-12 text-center">
          <SectionHeading
            ...
            title={
              <>
                Track Your <em className="Muuhu-italic">Order</em>
              </>
            }
            ...
            {trackingResult && (
              <div className="mt-8 space-y-6 border-t border-[var(--border)] pt-8">
                ...
                <div className="space-y-4">
                  <h4 className="Muuhu-display flex items-center gap-2 text-lg text-[var(--plum)]">
        ...
        <div className="mx-auto max-w-2xl space-y-8">
          <h3 className="Muuhu-display mb-6 text-center text-2xl text-[var(--plum)]">Tracking FAQ</h3>
