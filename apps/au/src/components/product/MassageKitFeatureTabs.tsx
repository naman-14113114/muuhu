...
const tabs = [
  {
    ...
    body: "Lightweight works at home, the office, or during travel. Smooth resin material.",
  ...
  },
  {
    ...
    title: "Premium Resin",
    body: "The resin kit combines 3 distinct massage tools for a focused skin and body care routine.",
  ...
  },
  {
    ...
    body: "Glide the Gua Sha over the target area for quick sessions, building gradually as your body gets used to massage therapy.",
    image: productAsset(
      "tab-4-rapid.jpeg",
      "muuhu-massage-kit",
    ),
