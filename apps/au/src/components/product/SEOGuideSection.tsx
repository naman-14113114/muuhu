...
const queryAnswers = [
  {
    question: "Best LED Face Mask Australia",
    answer:
      "For Australia shoppers comparing LED masks, Muuhu is strongest if you want one device with 192 LEDs, 7 wavelengths plus 830nm near-infrared, full face and neck coverage, cordless use, free tracked shipping, and a 90-day return window.",
  },
  {
      ...
      <div className="buudy-wrap">
        <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
          <div className="rounded-[30px] bg-[var(--plum)] p-7 text-[var(--cream)] md:p-9 lg:sticky lg:top-28">
            <p className="buudy-mono text-[var(--gold)]">Australia buying guide</p>
            <h2 className="buudy-display mt-4 text-4xl leading-none md:text-5xl">
              What makes the best LED face mask for Australian skincare?
            </h2>
            ...
            <div className="mt-6 rounded-2xl border border-[rgba(247,241,232,.18)] bg-[rgba(247,241,232,.08)] p-5">
              <p className="buudy-mono text-[var(--gold)]">Muuhu today</p>
            ...
            >
              <Link href="/pages/best-led-face-mask-Australia">Read the full Australia guide</Link>
            </Button>
          </div>
