...
export const muuhuIpl: Product = {
  ...
  description:
    "At-home IPL hair removal reimagined for Australian homes. The Muuhu Ultra Pro combines 999,999 flashes, built-in ice cooling at 8Ã‚Â°C, 9 adjustable energy levels up to 16J, Auto and Manual modes, and an LCD touch display for painless, long-lasting hair reduction across your entire body.",
  seoTitle: "Best IPL Hair Removal Australia | Muuhu Ice Cooling Device",
  seoDescription:
    "Shop the Muuhu Ultra Pro in Australia: 999,999 flashes, ice cooling, 9 energy levels, 16J max output, Auto and Manual modes, LCD touch display, 90-day returns, and free shipping.",
