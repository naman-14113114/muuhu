...
export const aboutSections = [
  ...
  },
  {
    ...
    title: "Our Story",
    copy: "The idea for Muuhu was born out of genuine frustration with the traditional skincare cycle. We were tired of spending a fortune on salon treatments that over-promised and expensive dermatologist visits that were hard to maintain.\n\nWe knew the science behind IPL hair removal worked, but the at-home devices available were either too weak, overpriced, or tethered you to a wall with bulky cords. So, we changed the standard. We created the Muuhu IPL: a sleek device packed with 999,999 flashes and ice cooling technology. Today, we're proud to have helped over 16,000 customers regain their confidence from the comfort of home.",
    image: {
      src: "/images/about/about-story-v3.webp",
      alt: "The story and inspiration behind the Muuhu IPL"
    },
