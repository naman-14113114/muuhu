...
export const metadata: Metadata = {
  title: "About Us | Australia LED Skincare Store - Muuhu",
  description:
    "Learn about Muuhu, our team of skincare advocates, our story of wire-free LED mask innovation, and our mission to make high-quality light therapy routines simple and effective.",
  alternates: {
