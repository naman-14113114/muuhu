...
const pageTitle = "Best IPL Hair Removal Australia 2026: What to Look For";
const pageDescription =
  "An Australian buyer's guide to choosing the best IPL hair removal device with ice cooling, high flash counts, and painless at-home treatment.";

const checkpoints = [
  {
    title: "Ice cooling technology",
    copy: "Ice cooling maintains a lower temperature at the treatment window (around 8°C), significantly reducing the heat sensation for a more comfortable and painless session.",
  },
  {
    title: "Adjustable energy levels",
    copy: "Different skin sensitivities require different intensities. Look for devices with multiple levels (up to 9) so you can start low and gradually increase the energy.",
  },
  {
    title: "High flash count",
    copy: "A device with 999,999 flashes offers years of full-body treatments without needing lamp replacements, making it a better long-term investment.",
  },
  {
    title: "Skin tone compatibility",
    copy: "IPL targets melanin, so it works best on light to medium skin tones with dark hair. Always check the Fitzpatrick scale compatibility before purchasing.",
  },
  {
    title: "Full-body coverage",
    copy: "Ensure the device has modes for both fast, continuous gliding on large areas (like legs) and precise stamping for smaller, sensitive areas.",
  },
  {
    title: "Safety guidance",
    copy: "Do not use if pregnant, breastfeeding, under 18, or taking photosensitising medication. Consult a professional if you have medical concerns.",
  },
];
...
const comparisonRows = [
  ...
  ["Max Energy", "16J output with 9 adjustable levels"],
  ["Treatment modes", "Auto (glide) and Manual (stamp)"],
  ["Display", "LCD touch screen with energy memory"],
  ["Australian offer", `${formatMoney(muuhuIpl.priceCents, muuhuIpl.currency)} launch price with free gift kit`],
  ["Guarantee", "90-day money back guarantee"],
];

export const metadata: Metadata = {
  title: "Best IPL Hair Removal Australia 2026 | Ice Cooling IPL Guide",
  description: pageDescription,
  alternates: {
    canonical: "/pages/best-ipl-hair-removal-australia",
  },
  keywords: [
    "Best IPL hair removal Australia",
    "IPL device Australia",
    "at-home laser hair removal Australia",
    "ice cooling IPL Australia",
    "painless hair removal device",
    "IPL with ice cooling",
    "Muuhu Ultra Pro",
  ],
  openGraph: {
    title: "Best IPL Hair Removal Australia 2026: Buyer Guide",
    description: pageDescription,
    url: absoluteUrl("/pages/best-ipl-hair-removal-australia"),
    type: "article",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Best IPL Hair Removal Australia 2026",
    description: pageDescription,
    images: ["/images/products/buudy-led-mask/09-buudy-led-mask-home-spa.webp"],
  },
};

export default function BestIplHairRemovalAustraliaPage() {
  const jsonLd = [
    organizationJsonLd(),
    websiteJsonLd(),
    ...
    breadcrumbJsonLd([
      { name: "Home", url: "/" },
      { name: "Best IPL Hair Removal Australia", url: "/pages/best-ipl-hair-removal-australia" },
    ]),
    ...guidePageJsonLd({
      title: pageTitle,
      description: pageDescription,
      url: "/pages/best-ipl-hair-removal-australia",
      faqs: iplSeoFaqs,
    }),
  ];
    ...
    <>
      ...
      <section className="buudy-section bg-[var(--plum)] py-16 text-[var(--cream)] md:py-24">
        <div className="buudy-wrap grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            <p className="buudy-mono text-[var(--gold)]">Australian IPL guide</p>
            <h1 className="buudy-display mt-5 text-5xl leading-none md:text-7xl">
              Best IPL Hair Removal Australia: how to choose one that works for your routine.
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-8 text-[rgba(247,241,232,.76)] md:text-lg">
              If you are comparing IPL hair removal devices in Australia, focus on
              flash count, ice cooling, adjustable energy levels, treatment modes, and
              whether the device fits your real beauty routine.
            </p>
          ...
          <figure className="relative min-h-[460px] overflow-hidden rounded-[34px] bg-[var(--ink)]">
            <Image
              alt="Muuhu Ultra Pro used at home in Australia"
        ...
        <div className="buudy-wrap">
          <div className="max-w-3xl">
            ...
            <h2 className="buudy-display mt-4 text-4xl leading-none text-[var(--plum)] md:text-6xl">
              For most Australian shoppers, the best IPL hair removal device is the one with
              ice cooling, high flash count, and easy full-body use.
            </h2>
            <p className="mt-5 text-base leading-8 text-[var(--muted)] md:text-lg">
              Muuhu is designed for that exact brief: 999,999 flashes, built-in ice cooling at 8°C,
              9 adjustable energy levels, Auto and Manual modes, and a launch bundle at{" "}
      ...
      <section className="buudy-section bg-[rgba(241,223,210,.5)] py-16 md:py-24" id="comparison">
        <div className="buudy-wrap grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            <p className="buudy-mono text-[var(--gold)]">Why Muuhu</p>
            <h2 className="buudy-display mt-4 text-4xl leading-none text-[var(--plum)] md:text-6xl">
              Built for the Australian buyer comparing premium IPL devices.
            </h2>
            <p className="mt-5 text-base leading-8 text-[var(--muted)]">
              The right IPL device should make home treatments fast and comfortable. Muuhu is positioned
              for shoppers who want painless ice cooling, enough energy levels for all skin sensitivities, and
              a complete kit without paying separate prices for accessories.
            </p>
            <div className="mt-7 flex items-start gap-4 rounded-[22px] bg-[var(--plum)] p-5 text-[var(--cream)]">
              ...
              <p className="text-sm leading-7 text-[rgba(247,241,232,.76)]">
                ...
                Results vary by user, consistency, and skin/hair type.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="mt-7 grid gap-3">
              {[
                ...
                "Built-in ice cooling technology",
