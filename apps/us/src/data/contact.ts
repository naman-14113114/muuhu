...
export const contactPage = {
  eyebrow: "Contact Muuhu",
  title: "We are here to help.",
  copy: "Welcome to Muuhu, where professional-grade IPL hair removal meets thoughtful support. We are delighted to assist you with product questions, order help, and anything you need for a smoother daily routine.",
  supportLabel: "support@muuhu.com",
...
export const contactHelpLinks = [
  ...
  },
  {
    ...
    copy: "Prefer email? Reach the Muuhu support desk directly.",
  },
];
...
export const publicSupportEmail = "support@muuhu.com";
