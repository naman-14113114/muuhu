...
export const transformations: Transformation[] = [
  {
    id: "result-01",
    image: productMediaAsset("8-12_Weeks.webp", "buudy-led-mask", "images"),
    concern: "Stubbles",
    title: "Best investment ever",
    quote: "By week 12, I noticed a huge reduction in leg hair growth.",
    name: "Donna P.",
  },
  {
    id: "result-02",
    image: productMediaAsset("ChatGPT Image Jun 25, 2026, 04_05_01 PM (1).png", "buudy-led-mask", "images"),
    concern: "Dark Underarms",
    title: "IT REALLY WORKS!!",
    quote: "After using for a short time, the shadow is gone.",
    name: "Jane P.",
  },
  {
    id: "result-03",
    image: productMediaAsset("ChatGPT Image Jun 25, 2026, 04_05_02 PM (2).png", "buudy-led-mask", "images"),
    concern: "Strawberry Legs",
    title: "Incredible results",
    quote: "My strawberry legs have completely vanished.",
    name: "Sarah K.",
  },
  {
    id: "result-04",
    image: productMediaAsset("ChatGPT Image Jun 25, 2026, 04_05_02 PM (3).png", "buudy-led-mask", "images"),
    concern: "Thick Hair",
    title: "Amazing for thick hair",
    quote: "Works perfectly on my thick hair.",
    name: "Amanda L.",
  },
  {
    id: "result-05",
    image: productMediaAsset("ChatGPT Image Jun 25, 2026, 04_05_03 PM (4).png", "buudy-led-mask", "images"),
    concern: "PCOS Regrowth",
    title: "Life changing",
    quote: "This device is a literal life changer for my PCOS.",
    name: "Rebecca H.",
  },
  {
    id: "result-06",
    image: productMediaAsset("ChatGPT Image Jun 25, 2026, 04_07_45 PM.png", "buudy-led-mask", "images"),
    concern: "Shaving Rash",
    title: "Literal Glow Up",
    quote: "No more razor bumps!",
    name: "Karen W.",
  },
  {
    id: "result-07",
    image: productMediaAsset("Weeks_1-4.webp", "buudy-led-mask", "images"),
    concern: "Fast Regrowth",
    title: "Skin looks refreshed",
    quote: "The regrowth is so slow now after 4 weeks.",
    name: "Linda S.",
  },
  {
    id: "result-08",
    image: productMediaAsset("Weeks_5-8.webp", "buudy-led-mask", "images"),
    concern: "Bikini Line",
    title: "Perfect for sensitive areas",
    quote: "I barely have to shave anymore by week 8.",
    name: "Emily T.",
  }
];
...
export const massagerFeatures: Feature[] = [
  {
    ...
    kicker: "Reduces puffiness",
    body: "Apply facial oil or serum and gently glide to reduce puffiness and promote lymphatic drainage.",
  },
  {
    title: "Massage Comb",
    kicker: "Relieves tension",
    body: "Wide-toothed resin comb perfect for massaging the scalp and neck, releasing deep tension without tangling hair.",
  },
  {
    title: "Beauty Pen",
    kicker: "Targeted relief",
    body: "Acupuncture beauty pen designed for precise application on specific tension points for focused relief.",
  },
];
...
export const massagerHowToUse = [
  "Apply a facial oil or serum to provide a smooth surface for the tools.",
  "Hold the Gua Sha board at a 15-degree angle to your skin.",
  "Gently glide the board upwards and outwards along your jawline, cheeks, and forehead.",
  "Use the massage comb on your scalp and neck to release deep tension.",
  "Apply the beauty pen to specific tension points for targeted relief.",
];
...
export const massagerFaqs: FAQItem[] = [
  {
    ...
    answer:
      "Apply a facial oil or serum, then gently glide the scraping board upwards and outwards along your jawline, cheeks, and forehead to reduce puffiness and promote lymphatic drainage.",
  },
  {
    question: "What is the massage comb used for?",
    answer:
      "The wide-toothed resin comb is perfect for massaging the scalp and neck. It releases deep tension without tangling or breaking your hair, providing ultimate relaxation.",
  },
  {
    question: "Can I use this kit anywhere on my body?",
    answer:
      "Yes! While primarily used for the face and neck, the tools are versatile enough to relieve tension on your back, shoulders, arms, and even feet.",
  },
  {
    question: "How do I clean the resin tools?",
    answer:
      "Simply wipe them clean with a damp cloth or wash them with mild soap and lukewarm water. Dry completely before storing them in the provided pouch.",
  },
];
...
export const comparison = {
  ...
  columns: [
    { label: "Muuhu", price: "$199", featured: true },
