...
function FaqAccordionItem({ question, answerHtml, isOpen, onClick }: FaqItemProps) {
  return (
    ...
    >
      ...
      >
        <span className={`Muuhu-display text-lg sm:text-xl text-[var(--plum)] font-normal transition-colors duration-300 ${
...
export function FaqPage() {
  ...
  return (
    <div className="bg-[var(--cream)] min-h-screen py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="Muuhu-glow -left-20 top-10 h-[360px] w-[360px] bg-[#ED6A3A] opacity-20" />
      <div className="Muuhu-glow -right-20 bottom-10 h-[420px] w-[420px] bg-[#a05080] opacity-20" />

      <div className="Muuhu-wrap relative z-10 max-w-4xl">
        {/* Page Headings */}
        <div className="text-center mb-16">
          <SectionHeading
            ...
            title={
              <>
                Frequently Asked <em className="Muuhu-italic">Questions</em>
              </>
            }
        ...
        <div className="mt-16 rounded-[24px] border border-[var(--border)] bg-[rgba(255,255,255,0.4)] backdrop-blur-md p-8 text-center max-w-2xl mx-auto shadow-[0_20px_50px_-28px_rgba(58,31,61,0.08)]">
          <h3 className="Muuhu-display text-2xl text-[var(--plum)]">Still have questions?</h3>
