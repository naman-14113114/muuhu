...
const queryAnswers = [
  {
    question: "Best LED Face Mask US",
    answer:
      "For US shoppers comparing LED masks, Muuhu is strongest if you want one device with 192 LEDs, 7 wavelengths plus 830nm near-infrared, full face and neck coverage, cordless use, free tracked shipping, and a 90-day return window.",
  },
  {
        ...
        <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
          <div className="rounded-[30px] bg-[var(--plum)] p-7 text-[var(--cream)] md:p-9 lg:sticky lg:top-28">
            ...
            <h2 className="Muuhu-display mt-4 text-4xl leading-none md:text-5xl">
              What makes the best LED face mask for US skincare?
            </h2>
            ...
            >
              <Link href="/pages/best-led-face-mask-US">Read the full US guide</Link>
            </Button>
          </div>
