...
const tabs = [
  {
    ...
    body: "Compact and lightweight design works at home, the office, or during travel. Premium smooth resin for easy use.",
    image: productAsset("tab-1-compact.jpeg", "muuhu-massage-kit"),
  },
  {
    id: "clinical-strength",
    tabLabel: "Comprehensive Kit",
    title: "Comprehensive Kit",
    body: "The resin kit combines a Gua Sha board, massage comb, and beauty pen for a focused skin and body care routine.",
    image: productAsset("tab-2-clinical.jpeg", "muuhu-massage-kit"),
  },
  {
    id: "targeted-relief",
    tabLabel: "Targeted Relief",
    title: "Targeted Relief",
    body: "Use the specific massage tools for localized application on the face, back, knees, shoulders, hands, feet, or other target areas.",
  ...
  },
  {
    ...
    body: "Glide the Gua Sha over the target area for quick sessions, building gradually for optimal tension relief and lymphatic drainage.",
    image: productAsset(
      "tab-4-rapid.jpeg",
      "muuhu-massage-kit",
    ),
