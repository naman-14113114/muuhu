          ...
          {(product.template === "massage-kit" ? massagerFeatures : features).map((feature, index) => {
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="Muuhu-display text-sm text-[var(--gold)] font-medium self-start mt-1">
          ...
          {product.included.map((item) => (
            ...
            >
              <span className="flex items-center gap-3">
                <span className="Muuhu-mono text-[var(--gold)]">{item.quantity}</span>
                <span className="text-sm font-semibold text-[var(--plum)]">
                  {item.label}
                </span>
              </span>
              {item.tag ? (
                <span className="Muuhu-mono rounded-full bg-[rgba(184,149,86,.18)] px-3 py-1 text-[var(--plum)]">
                  {item.tag}
                </span>
              ) : null}
            </li>
