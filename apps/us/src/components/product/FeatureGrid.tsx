...
export function FeatureGrid() {
  ...
  return (
    <section className="Muuhu-section border-y border-[var(--border)] bg-[rgba(241,223,210,.42)] md: md: py-14 md:py-24">
      <div className="Muuhu-wrap">
        <SectionHeading
          ...
          title={
            <>
              What makes our mask{" "}
              <em className="Muuhu-italic text-[var(--gold)]">unique</em>?
            </>
          }
        />
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex flex-1 items-center gap-4">
                    ...
                    <span className="Muuhu-display text-base text-[var(--gold)] font-medium">
                      {String(index + 1).padStart(2, "0")}
                    </span>
                  </div>
                </div>
                <h3 className="Muuhu-display mt-6 text-2xl text-[var(--plum)] transition-colors duration-300 group-hover:text-[var(--gold)]">
                  {feature.title}
                </h3>
                <p className="Muuhu-display mt-2.5 italic text-[var(--plum-soft)]">
                  {feature.kicker}
                </p>
                ...
                <li className="border-b border-[var(--border)] last:border-b-0" key={`mobile-${feature.title}`}>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="Muuhu-display text-[0.95rem] leading-tight text-[var(--plum)] truncate">
                        {feature.title}
                      </h3>
                      <p className="Muuhu-display mt-0.5 text-[0.8rem] italic text-[var(--plum-soft)] truncate">
                        {feature.kicker}
                      </p>
                    </div>
                    <div className="flex flex-none items-center gap-2">
                      <span className="Muuhu-display text-sm text-[var(--gold)] font-medium">
                        {String(index + 1).padStart(2, "0")}
                      </span>
                      <Plus
