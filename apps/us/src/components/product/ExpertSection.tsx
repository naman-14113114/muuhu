...
export function ExpertSection() {
  ...
  return (
    <section className="Muuhu-section bg-[var(--cream)] md: md: py-14 md:py-24" id="expert">
      <div className="Muuhu-wrap grid items-center gap-6 md:gap-8 lg:grid-cols-[1fr_1.3fr]">
        ...
        <div>
          <p className="Muuhu-eyebrow">Expert</p>
          <h2 className="Muuhu-display mt-2 text-[2.5rem] leading-tight text-[var(--plum)] md:text-5xl">
            Dr. Gabriella <em className="Muuhu-italic">Vasili</em>, MD
          </h2>
          <p className="Muuhu-display mt-2 text-xl italic text-[var(--plum-soft)]">
            Double Board-Certified Dermatologist
          </p>
          <div className="Muuhu-copy mt-4 space-y-3">
            <p>
