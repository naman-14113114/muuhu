    ...
    <form action={formAction} className="grid gap-5">
      <div className="grid gap-5 md:grid-cols-2">
        <label className="block">
          <span className="Muuhu-mono text-[var(--plum)]">Full name</span>
          <input
        ...
        <label className="block">
          <span className="Muuhu-mono text-[var(--plum)]">Email</span>
          <input
        ...
        <label className="block">
          <span className="Muuhu-mono text-[var(--plum)]">Phone</span>
          <input
            autoComplete="tel"
        ...
        <label className="block">
          <span className="Muuhu-mono text-[var(--plum)]">Country</span>
          <input
      ...
      <label className="block">
        <span className="Muuhu-mono text-[var(--plum)]">Shipping address</span>
        <input
      ...
      <label className="block">
        <span className="Muuhu-mono text-[var(--plum)]">Apartment, suite, etc.</span>
        <input
      ...
      <div className="grid gap-5 md:grid-cols-3">
        <label className="block">
          <span className="Muuhu-mono text-[var(--plum)]">City</span>
          <input
        ...
        <label className="block">
          <span className="Muuhu-mono text-[var(--plum)]">State</span>
          <input
        ...
        <label className="block">
          <span className="Muuhu-mono text-[var(--plum)]">Postal code</span>
          <input
