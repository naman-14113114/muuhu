    ...
    return (
      <section className="Muuhu-section bg-[var(--cream)] py-20 md:py-28">
        <div className="Muuhu-wrap max-w-2xl text-center">
          ...
          <h1 className="Muuhu-heading mt-5">Order not found.</h1>
    ...
    <section className="Muuhu-section bg-[var(--cream)] py-16 md:py-24">
      <div className="Muuhu-wrap">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="Muuhu-eyebrow mt-5">Sale recorded</p>
          <h1 className="Muuhu-heading mt-3">Thank you, {order.customer_full_name}.</h1>
          <p className="Muuhu-copy mx-auto mt-5 max-w-2xl">
            Your Muuhu order has been recorded as {order.order_number}. A real
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-8 lg:grid-cols-[1fr_360px]">
          <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-5 md:p-6">
            <div className="flex flex-col justify-between gap-4 border-b border-[var(--border)] pb-5 md:flex-row md:items-center">
              <div>
                <p className="Muuhu-mono text-[var(--gold)]">Order</p>
                <h2 className="Muuhu-display mt-2 text-3xl text-[var(--plum)]">
                  {order.order_number}
                </h2>
              ...
              <p className="Muuhu-display text-4xl text-[var(--plum)]">
          ...
          <aside className="space-y-5">
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Customer</p>
            ...
            <div className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6">
              <p className="Muuhu-mono text-[var(--gold)]">Summary</p>
...
function OrderSetupNotice({ orderNumber }: { orderNumber: string }) {
  return (
    <section className="Muuhu-section bg-[var(--cream)] py-20 md:py-28">
      <div className="Muuhu-wrap max-w-2xl text-center">
        <PackageCheck className="mx-auto text-[var(--gold)]" size={46} />
        <h1 className="Muuhu-heading mt-5">Order storage needs setup.</h1>
        <p className="Muuhu-copy mx-auto mt-5 max-w-lg">
